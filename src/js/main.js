...
const ORGANIZER_DATA = [
  ...
  new organizer(
    ...
    "./images/organizer/Eesha.png"
  ),
  new organizer(
    "Hrishita Chakrabarti",
    "Vice Chair - Management",
    "./images/organizer/Hrishita.jpg"
  ),
  new organizer(
    "Anjali Roy",
    "General Secretary",
    "./images/organizer/Anjali.jpg"
  ),
  new organizer(
    "Kashish Mittal",
    "Web Master",
  ...
  new organizer(
    "Shovin Kakaraddi",
    "UI UX Lead",
    "./images/organizer/Shovin.jpg"
  ),
  new organizer("Dhruv Roy", "Treasurer", "./images/organizer/Dhruv.jpg"),
  new organizer(
    "Nimit Jain",
    "Competitive Lead",
  ...
  new organizer(
    "Garima Bothra",
    "Projects Lead - App",
    "./images/organizer/Garima.jpg"
  ),
  new organizer(
    "Elio Jordan Lopes",
    "Projects Lead - Web",
    "./images/organizer/Elio.png"
  ),
  new organizer(
    "Siddharth Nahar",
    "Competitive Guide",
    "./images/organizer/Siddharth.jpg"
  ),
  new organizer(
    "Sriya Reddi",
    "Operations Head",
